    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            while (!check)
            {
                ...
                try
                {
                    if(!string.IsNullOrWhiteSpace(input)) CheckInput(input);
                }
                catch (Exception ex)
                {
                ...
                switch (input)
                {
                    ...
                    //    try
                    //    {
                    //        authorService.Create(new Author() { Name = authorName });
                    //    }
                    //    catch (Exception ex)
                    //    {
                    //        Console.WriteLine(ex.Message);
                    ...
                    //case "4":
                    //    Console.WriteLine("Enter id:");
                    //    int updateAuthorId = Convert.ToInt32(Console.ReadLine());
                    ...
                    //    try
                    //    {
                    //        authorService.Update(updateAuthorId, new Author() { Name = updateAuthorName });
                    //    }
                    //    catch (Exception ex)
                    //    {
                    //        Console.WriteLine(ex.Message);
                    ...
                    //    try
                    //    {
                    //        foreach (var bookItem in bookService.GetAll())
                    //        {
                    ...
                    //    Console.WriteLine("Enter new book published year:");
                    //    int updateBookPublishedYear = Convert.ToInt32(Console.ReadLine());

                    //    try
                    //    {
                    //        bookService.Update(updateBookId, new Book() { 
